...
# Tên driver mà nền tảng (GitHub/GitLab) dùng làm khoá nhận diện cảnh báo: đổi tên là mất liên kết với mọi cảnh báo đang mở.
TOOL_NAME = "AIScan"
TOOL_URI = "https://netmind.viettel.vn/codev"  # TODO: đổi thành URL repo AIScan trên Codev
PROPERTY_BAG = "aiscan"
ID_PREFIX = "aiscan"
FINDING_ID: Final = "aiscanFindingId"
ID_VERSION = "v3"
CONTEXT_LINES = 3
SRCROOT = "%SRCROOT%"
