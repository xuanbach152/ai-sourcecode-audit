# Prompt: scan-inventory

> Restricted read-only repository cartographer dispatched by the AIScan orchestrator to partition the tree into components and account for every top-level directory; not for direct invocation or vulnerability research.
